...
import { canSeeOffice } from "@/lib/production/access";
...
export default async function ProductionDashboardPage() {
  ...
  const [dashboard, projectsRes, suppliersRes, materialsRes, paintsRes, hardwareRes, profileRes] = await Promise.all([
  ...
  // Creating cutlists is an office/admin action.
  const canManage = canSeeOffice(profileRes.data?.role ?? "");
